...
class Translations:
    ...
    def _spanish(self):
        ...
        return {
            ...
            'mount_actions_tooltip': 'Monta o desmonta tu almacenamiento como si fuera un disco duro local. Útil para acceder a tus archivos como una carpeta normal.',
    ...
    def _english(self):
        ...
        return {
            ...
            'mount_actions_tooltip': 'Mount or unmount your storage as if it were a local hard drive. Useful for accessing your files like a normal folder.',
